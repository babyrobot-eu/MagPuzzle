...
public class GazePlotter : MonoBehaviour
{
    ...
    private const int TimeToPopOptionsInDialogInfo = 500;
    ...
    private GameObject lastDialogGameObject;
    private DateTime timeGazingAtInfo;
	...
	private void UpdateGazePointCloud(GazePoint gazePoint)
	{
        ...
        Dbg.Log(LogMessageType.TOBII, new List<string>() { pointer.position.x.ToString(), pointer.position.y.ToString() });
